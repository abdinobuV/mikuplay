      ...
      child: Form(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Center(child: Text(
              ...
              style: TextStyle(fontSize: 14, color: AppColors.skyOp(0.75),
                  height: 1.55))),
...
class _SuccessView extends StatelessWidget {
  ...
  const _SuccessView({super.key,
    required this.email, required this.onBack, required this.onResend});
      ...
      child: Column(children: [
        ...
        Container(
            ...
            decoration: BoxDecoration(shape: BoxShape.circle,
                color: AppColors.tealOp(0.12),
                border: Border.all(color: AppColors.tealOp(0.5), width: 1.5)),
            child: const Center(child: Icon(Icons.mark_email_read_rounded,
        ...
        Container(
          ...
          child: Column(children: [
            ...
            Text("Click the link in the email to reset your password.\n"
                ...
                textAlign: TextAlign.center,
                style: TextStyle(fontSize: 12, color: AppColors.skyOp(0.6),
                    height: 1.5)),
          ]),
        ),
